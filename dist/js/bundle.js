...
const flipper = __webpack_require__(3);
...
const modalWindow = __webpack_require__(7);

if($('.form-buttons_submit').length) {
  modalWindow()
}

const email = __webpack_require__(8);

if($('.callback-form').length) {
  email()
}

const preloder =__webpack_require__(9);
...
let images = document.images,
    ...
    perc_display = document.querySelector('.preloader__percents'),
